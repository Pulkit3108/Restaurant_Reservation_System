...
<div class="login_wrapper">
	...
	<div class="login_holder">
		...
		<form method="post" action="index.php">
			...
			<div class="header">
				<h4 style="border-bottom: 3px solid #335eff; " class="title">ADMIN LOGIN</h4>
			</div>
			...
			<input type="submit" name="submit" value="Login" class="btn btn-info btn-fill pull-right" style="background: #335eff;  border-color: #335eff; " />
